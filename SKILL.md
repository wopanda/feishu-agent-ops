...
description: 当用户要把一批已创建好的飞书机器人接入 OpenClaw，完成多 Agent 新增、扩容、巡检或修复时使用。适用于“从 1 个扩到多个”“从多个扩到更多个”“检查多 Agent 异常”“修复 bindings / workspace / 会话隔离问题”这类场景。默认先做规划预览，再执行落地；在异常场景默认走 Root-Cause-First（根因优先）流程。
---
