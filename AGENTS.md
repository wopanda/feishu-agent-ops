...
5. If `shared-context/FEEDBACK-LOG.md` exists: read it before replying to align with latest cross-task feedback
...
**注意：当前这条规则默认服务于《小龙虾 OpenClaw》出书项目，不按抽象“泛写书”理解。**

触发信号包括：
- 讨论小龙虾出书、12章、章节推进、哪章先写
- 讨论章节文件夹、命名、提纲、素材、准成稿、成稿
- 讨论配置类章节（如飞书、企业微信、Skill、自动化配置）
- 讨论截图占位符、后补截图、待实测标记
- 讨论“成稿放哪里”“调研怎么转成正文”“要不要批量建章节结构”
- 形成了未来会复用的《小龙虾》项目写作规则或目录规则
